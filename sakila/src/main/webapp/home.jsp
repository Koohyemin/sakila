...
<body>
	...
	<div class="jumbotron">
	  ...
	  <span>SAKILA DVD TOP10 영화와 배우 리스트를 참고해 DVD를 대여해보세요!</span>
	  	...
	  	<div class="container">
		<h1 class="text-center"><span><img src="<%=request.getContextPath()%>/image/movie_icon.png" style="height: 60px; width: 60px;"></span> SAKILA DVD <span class="text-danger">BEST 10</span> FILM</h1>
		<table class="table">
		...
		<h1 class="text-center"><span><img src="<%=request.getContextPath()%>/image/actor_icon.png" style="height: 60px; width: 60px;"></span>SAKILA DVD <span class="text-danger">BEST 10</span> ACTOR</h1>
		<table class="table">
			<thead class="text-center text-light" style="background:#00004B;">
				<tr>
					<th>배우 번호</th>
